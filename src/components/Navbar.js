...
const Navbar = () => {
  ...
  return(
    <>
      <nav className="p-5 bg-slate-700 shadow md:flex md:items-center md:justify-between text-black font-medium">
        ...
        ${clicked ? ('z-30 pl-7 py-4 fixed bg-slate-700'):('opacity-0 top-[-400px] z-[-1] absolute')}
          ...
          <li className="mx-4 my-2 md:my-0">
            <Link to='/projects' className="hover:text-zinc-500 duration-500" onClick={handleClickListItem}>Projects</Link>
          </li>
        </ul>
      </nav>
    </>
